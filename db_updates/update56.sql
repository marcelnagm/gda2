...
ALTER TABLE tbdisciplina ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbturma ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tboferta ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbdisciplina_ignorada ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbdisciplinarequisitos ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbgrade_equivalente ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbhistorico ALTER cod_disciplina TYPE character varying(12);
ALTER TABLE tbcurriculodisciplinas ALTER cod_disciplina TYPE character varying(12);
