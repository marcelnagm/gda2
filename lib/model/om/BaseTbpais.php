...
/**
 * Base class that represents a row from the 'tbpais' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbpais extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Tbcidade[] Collection to store aggregation of Tbcidade objects.
	 */
	protected $collTbcidades;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTbcidades.
	 */
	private $lastTbcidadeCriteria = null;

	/**
	 * @var        array Tbestado[] Collection to store aggregation of Tbestado objects.
	 */
	protected $collTbestados;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTbestados.
	 */
	private $lastTbestadoCriteria = null;
	 ...
	 * @return     Tbpais The current object (for fluent API support)
	 */
	public function setIdPais($v)
	{
		...
		if ($this->id_pais !== $v) {
			$this->id_pais = $v;
			$this->modifiedColumns[] = TbpaisPeer::ID_PAIS;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbpaisPeer::DESCRICAO;
		}
	...
	public function setSucinto($v)
	{
		...
		if ($this->sucinto !== $v) {
			$this->sucinto = $v;
			$this->modifiedColumns[] = TbpaisPeer::SUCINTO;
		}
	...
	public function setNacionalidade($v)
	{
		...
		if ($this->nacionalidade !== $v) {
			...
			$this->modifiedColumns[] = TbpaisPeer::NACIONALIDADE;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbpaisPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbpaisPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbpaisPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbpaisPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nacionalidade = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			...
			return $startcol + 8; // 8 = TbpaisPeer::NUM_COLUMNS - TbpaisPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbpais object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbpaisPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collTbcidades = null;
			$this->lastTbcidadeCriteria = null;

			$this->collTbestados = null;
			$this->lastTbestadoCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(TbpaisPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbpais:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbpaisPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbpais:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbpais:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbpaisPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbpaisPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbpais:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbpaisPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbpaisPeer::doInsert($this, $con);
					...
					$affectedRows += TbpaisPeer::doUpdate($this, $con);
				}
			...
			if ($this->collTbcidades !== null) {
				foreach ($this->collTbcidades as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collTbestados !== null) {
				foreach ($this->collTbestados as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbpaisPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbpaisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setNacionalidade($arr[$keys[3]]);
	...
	{
		$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);

		if ($this->isColumnModified(TbpaisPeer::ID_PAIS)) $criteria->add(TbpaisPeer::ID_PAIS, $this->id_pais);
		if ($this->isColumnModified(TbpaisPeer::DESCRICAO)) $criteria->add(TbpaisPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbpaisPeer::SUCINTO)) $criteria->add(TbpaisPeer::SUCINTO, $this->sucinto);
		if ($this->isColumnModified(TbpaisPeer::NACIONALIDADE)) $criteria->add(TbpaisPeer::NACIONALIDADE, $this->nacionalidade);
		if ($this->isColumnModified(TbpaisPeer::CREATED_AT)) $criteria->add(TbpaisPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbpaisPeer::UPDATED_AT)) $criteria->add(TbpaisPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbpaisPeer::CREATED_BY)) $criteria->add(TbpaisPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbpaisPeer::UPDATED_BY)) $criteria->add(TbpaisPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbpaisPeer::ID_PAIS, $this->id_pais);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbpais (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getTbcidades() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTbcidade($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getTbestados() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTbestado($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbpais Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Tbpais has previously been saved, it will retrieve
	 * related Tbalunomatriculas from storage. If this Tbpais is new, it will return
		...
		if ($this->collTbalunomatriculas === null) {
			if ($this->isNew()) {
			   $this->collTbalunomatriculas = array();
				...
				$criteria->add(TbalunomatriculaPeer::NACIONALIDADE, $this->id_pais);
	 ...
	 * Otherwise if this Tbpais is new, it will return
	 * an empty collection; or if this Tbpais has previously
	 * been saved, it will retrieve related Tbalunomatriculas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbpais.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpais has previously been saved, it will retrieve
	 * related Tbalunobackups from storage. If this Tbpais is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunobackups === null) {
			if ($this->isNew()) {
			   $this->collTbalunobackups = array();
				...
				$criteria->add(TbalunobackupPeer::NACIONALIDADE, $this->id_pais);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpais has previously been saved, it will retrieve
	 * related Tbalunos from storage. If this Tbpais is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunos === null) {
			if ($this->isNew()) {
			   $this->collTbalunos = array();
				...
				$criteria->add(TbalunoPeer::NACIONALIDADE, $this->id_pais);
	...
	/**
	 * Clears out the collTbcidades collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTbcidades()
	 */
	public function clearTbcidades()
	{
		$this->collTbcidades = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTbcidades collection (array).
	 *
	 * By default this just sets the collTbcidades collection to an empty array (like clearcollTbcidades());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTbcidades()
	{
		$this->collTbcidades = array();
	}

	/**
	 * Gets an array of Tbcidade objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpais has previously been saved, it will retrieve
	 * related Tbcidades from storage. If this Tbpais is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Tbcidade[]
	 * @throws     PropelException
	 */
	public function getTbcidades($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTbcidades === null) {
			if ($this->isNew()) {
			   $this->collTbcidades = array();
				...
				$criteria->add(TbcidadePeer::ID_PAIS, $this->id_pais);

				TbcidadePeer::addSelectColumns($criteria);
				$this->collTbcidades = TbcidadePeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TbcidadePeer::addSelectColumns($criteria);
				if (!isset($this->lastTbcidadeCriteria) || !$this->lastTbcidadeCriteria->equals($criteria)) {
					$this->collTbcidades = TbcidadePeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTbcidadeCriteria = $criteria;
		return $this->collTbcidades;
	}

	/**
	 * Returns the number of related Tbcidade objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Tbcidade objects.
	 * @throws     PropelException
	 */
	public function countTbcidades(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTbcidades === null) {
			if ($this->isNew()) {
				...
				$count = TbcidadePeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTbcidadeCriteria) || !$this->lastTbcidadeCriteria->equals($criteria)) {
					...
					$count = count($this->collTbcidades);
				}
			} else {
				$count = count($this->collTbcidades);
			}
	...
	/**
	 * Method called to associate a Tbcidade object to this object
	 * through the Tbcidade foreign key attribute.
	 *
	 * @param      Tbcidade $l Tbcidade
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTbcidade(Tbcidade $l)
	{
		if ($this->collTbcidades === null) {
			$this->initTbcidades();
		}
		if (!in_array($l, $this->collTbcidades, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTbcidades, $l);
			$l->setTbpais($this);
		}
	}
	 ...
	 * Otherwise if this Tbpais is new, it will return
	 * an empty collection; or if this Tbpais has previously
	 * been saved, it will retrieve related Tbcidades from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbpais.
	 */
	public function getTbcidadesJoinTbestado($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTbcidades === null) {
			if ($this->isNew()) {
				...
				$this->collTbcidades = TbcidadePeer::doSelectJoinTbestado($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collTbestados collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTbestados()
	 */
	public function clearTbestados()
	{
		$this->collTbestados = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTbestados collection (array).
	 *
	 * By default this just sets the collTbestados collection to an empty array (like clearcollTbestados());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTbestados()
	{
		$this->collTbestados = array();
	}

	/**
	 * Gets an array of Tbestado objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpais has previously been saved, it will retrieve
	 * related Tbestados from storage. If this Tbpais is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Tbestado[]
	 * @throws     PropelException
	 */
	public function getTbestados($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);
		}
		...
		if ($this->collTbestados === null) {
			if ($this->isNew()) {
			   $this->collTbestados = array();
				...
				$criteria->add(TbestadoPeer::ID_PAIS, $this->id_pais);

				TbestadoPeer::addSelectColumns($criteria);
				$this->collTbestados = TbestadoPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TbestadoPeer::addSelectColumns($criteria);
				if (!isset($this->lastTbestadoCriteria) || !$this->lastTbestadoCriteria->equals($criteria)) {
					$this->collTbestados = TbestadoPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTbestadoCriteria = $criteria;
		return $this->collTbestados;
	}

	/**
	 * Returns the number of related Tbestado objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Tbestado objects.
	 * @throws     PropelException
	 */
	public function countTbestados(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbpaisPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTbestados === null) {
			if ($this->isNew()) {
				...
				$count = TbestadoPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTbestadoCriteria) || !$this->lastTbestadoCriteria->equals($criteria)) {
					...
					$count = count($this->collTbestados);
				}
			} else {
				$count = count($this->collTbestados);
			}
	...
	/**
	 * Method called to associate a Tbestado object to this object
	 * through the Tbestado foreign key attribute.
	 *
	 * @param      Tbestado $l Tbestado
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTbestado(Tbestado $l)
	{
		if ($this->collTbestados === null) {
			$this->initTbestados();
		}
		if (!in_array($l, $this->collTbestados, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTbestados, $l);
			$l->setTbpais($this);
		}
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collTbcidades) {
				foreach ((array) $this->collTbcidades as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collTbestados) {
				foreach ((array) $this->collTbestados as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbpais:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbpais::%s', $method));
	  }
