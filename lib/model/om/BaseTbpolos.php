...
/**
 * Base class that represents a row from the 'tbpolos' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbpolos extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbpolos The current object (for fluent API support)
	 */
	public function setIdPolo($v)
	{
		...
		if ($this->id_polo !== $v) {
			$this->id_polo = $v;
			$this->modifiedColumns[] = TbpolosPeer::ID_POLO;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbpolosPeer::DESCRICAO;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbpolosPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbpolosPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbpolosPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbpolosPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_polo = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 6; // 6 = TbpolosPeer::NUM_COLUMNS - TbpolosPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbpolos object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbpolosPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbpolos:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbpolosPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbpolos:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbpolos:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbpolosPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbpolosPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbpolos:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbpolosPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbpolosPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdPolo($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbpolosPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbpolosPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbpolosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbpolosPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdPolo(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdPolo($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbpolosPeer::ID_POLO)) $criteria->add(TbpolosPeer::ID_POLO, $this->id_polo);
		if ($this->isColumnModified(TbpolosPeer::DESCRICAO)) $criteria->add(TbpolosPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbpolosPeer::CREATED_AT)) $criteria->add(TbpolosPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbpolosPeer::UPDATED_AT)) $criteria->add(TbpolosPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbpolosPeer::CREATED_BY)) $criteria->add(TbpolosPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbpolosPeer::UPDATED_BY)) $criteria->add(TbpolosPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbpolosPeer::ID_POLO, $this->id_polo);
	...
	/**
	 * Generic method to set the primary key (id_polo column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbpolos (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdPolo(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbpolos Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Tbpolos has previously been saved, it will retrieve
	 * related Tbalunomatriculas from storage. If this Tbpolos is new, it will return
		...
		if ($this->collTbalunomatriculas === null) {
			if ($this->isNew()) {
			   $this->collTbalunomatriculas = array();
				...
				$criteria->add(TbalunomatriculaPeer::ID_POLO, $this->id_polo);
	 ...
	 * Otherwise if this Tbpolos is new, it will return
	 * an empty collection; or if this Tbpolos has previously
	 * been saved, it will retrieve related Tbalunomatriculas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbpolos.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpolos has previously been saved, it will retrieve
	 * related Tbalunobackups from storage. If this Tbpolos is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunobackups === null) {
			if ($this->isNew()) {
			   $this->collTbalunobackups = array();
				...
				$criteria->add(TbalunobackupPeer::ID_POLO, $this->id_polo);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpolos has previously been saved, it will retrieve
	 * related Tbalunos from storage. If this Tbpolos is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunos === null) {
			if ($this->isNew()) {
			   $this->collTbalunos = array();
				...
				$criteria->add(TbalunoPeer::ID_POLO, $this->id_polo);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbpolos has previously been saved, it will retrieve
	 * related Tbofertas from storage. If this Tbpolos is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbofertas === null) {
			if ($this->isNew()) {
			   $this->collTbofertas = array();
				...
				$criteria->add(TbofertaPeer::ID_POLO, $this->id_polo);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbpolos:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbpolos::%s', $method));
	  }
