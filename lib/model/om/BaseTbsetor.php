...
/**
 * Base class that represents a row from the 'tbsetor' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbsetor extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbsetor The current object (for fluent API support)
	 */
	public function setIdSetor($v)
	{
		...
		if ($this->id_setor !== $v) {
			$this->id_setor = $v;
			$this->modifiedColumns[] = TbsetorPeer::ID_SETOR;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbsetorPeer::DESCRICAO;
		}
	...
	public function setSucinto($v)
	{
		...
		if ($this->sucinto !== $v) {
			$this->sucinto = $v;
			$this->modifiedColumns[] = TbsetorPeer::SUCINTO;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbsetorPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbsetorPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbsetorPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbsetorPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_setor = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 7; // 7 = TbsetorPeer::NUM_COLUMNS - TbsetorPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbsetor object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbsetorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbsetor:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbsetorPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbsetor:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbsetor:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbsetorPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbsetorPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbsetor:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbsetorPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbsetorPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdSetor($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbsetorPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbsetorPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbsetorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbsetorPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdSetor(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdSetor($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbsetorPeer::ID_SETOR)) $criteria->add(TbsetorPeer::ID_SETOR, $this->id_setor);
		if ($this->isColumnModified(TbsetorPeer::DESCRICAO)) $criteria->add(TbsetorPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbsetorPeer::SUCINTO)) $criteria->add(TbsetorPeer::SUCINTO, $this->sucinto);
		if ($this->isColumnModified(TbsetorPeer::CREATED_AT)) $criteria->add(TbsetorPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbsetorPeer::UPDATED_AT)) $criteria->add(TbsetorPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbsetorPeer::CREATED_BY)) $criteria->add(TbsetorPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbsetorPeer::UPDATED_BY)) $criteria->add(TbsetorPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbsetorPeer::ID_SETOR, $this->id_setor);
	...
	/**
	 * Generic method to set the primary key (id_setor column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbsetor (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdSetor(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbsetor Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Tbsetor has previously been saved, it will retrieve
	 * related Tbcurriculodisciplinass from storage. If this Tbsetor is new, it will return
		...
		if ($this->collTbcurriculodisciplinass === null) {
			if ($this->isNew()) {
			   $this->collTbcurriculodisciplinass = array();
				...
				$criteria->add(TbcurriculodisciplinasPeer::ID_SETOR, $this->id_setor);
	 ...
	 * Otherwise if this Tbsetor is new, it will return
	 * an empty collection; or if this Tbsetor has previously
	 * been saved, it will retrieve related Tbcurriculodisciplinass from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbsetor.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbsetor has previously been saved, it will retrieve
	 * related Tbcursoversaos from storage. If this Tbsetor is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbcursoversaos === null) {
			if ($this->isNew()) {
			   $this->collTbcursoversaos = array();
				...
				$criteria->add(TbcursoversaoPeer::ID_SETOR, $this->id_setor);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbsetor has previously been saved, it will retrieve
	 * related Tbofertas from storage. If this Tbsetor is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbofertas === null) {
			if ($this->isNew()) {
			   $this->collTbofertas = array();
				...
				$criteria->add(TbofertaPeer::ID_SETOR, $this->id_setor);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbsetor has previously been saved, it will retrieve
	 * related Tbprofessors from storage. If this Tbsetor is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbprofessors === null) {
			if ($this->isNew()) {
			   $this->collTbprofessors = array();
				...
				$criteria->add(TbprofessorPeer::ID_SETOR, $this->id_setor);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbsetor:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbsetor::%s', $method));
	  }
