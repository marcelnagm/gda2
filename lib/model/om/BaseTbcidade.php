...
/**
 * Base class that represents a row from the 'tbcidade' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbcidade extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Tbcampus[] Collection to store aggregation of Tbcampus objects.
	 */
	protected $collTbcampuss;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTbcampuss.
	 */
	private $lastTbcampusCriteria = null;
	 ...
	 * @return     Tbcidade The current object (for fluent API support)
	 */
	public function setIdCidade($v)
	{
		...
		if ($this->id_cidade !== $v) {
			$this->id_cidade = $v;
			$this->modifiedColumns[] = TbcidadePeer::ID_CIDADE;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbcidadePeer::DESCRICAO;
		}
	...
	public function setIdEstado($v)
	{
		...
		if ($this->id_estado !== $v) {
			$this->id_estado = $v;
			$this->modifiedColumns[] = TbcidadePeer::ID_ESTADO;
		}

		if ($this->aTbestado !== null && $this->aTbestado->getIdEstado() !== $v) {
			$this->aTbestado = null;
		}
	...
	public function setIdPais($v)
	{
		...
		if ($this->id_pais !== $v) {
			$this->id_pais = $v;
			$this->modifiedColumns[] = TbcidadePeer::ID_PAIS;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbcidadePeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbcidadePeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbcidadePeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbcidadePeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = TbcidadePeer::NUM_COLUMNS - TbcidadePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbcidade object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aTbestado !== null && $this->id_estado !== $this->aTbestado->getIdEstado()) {
			$this->aTbestado = null;
		}
		if ($this->aTbpais !== null && $this->id_pais !== $this->aTbpais->getIdPais()) {
			$this->aTbpais = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbcidadePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collTbcampuss = null;
			$this->lastTbcampusCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		if ($con === null) {
			$con = Propel::getConnection(TbcidadePeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbcidade:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbcidadePeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbcidade:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbcidade:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbcidadePeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbcidadePeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbcidade:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbcidadePeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aTbestado !== null) {
				if ($this->aTbestado->isModified() || $this->aTbestado->isNew()) {
					$affectedRows += $this->aTbestado->save($con);
				}
				$this->setTbestado($this->aTbestado);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbcidadePeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdCidade($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbcidadePeer::doUpdate($this, $con);
				}
			...
			if ($this->collTbcampuss !== null) {
				foreach ($this->collTbcampuss as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aTbestado !== null) {
				if (!$this->aTbestado->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aTbestado->getValidationFailures());
				}
			}
			...
			if (($retval = TbcidadePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbcidadePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbcidadePeer::getFieldNames($keyType);
		$result = array(
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdCidade($arr[$keys[0]]);
	...
	{
		$criteria = new Criteria(TbcidadePeer::DATABASE_NAME);

		if ($this->isColumnModified(TbcidadePeer::ID_CIDADE)) $criteria->add(TbcidadePeer::ID_CIDADE, $this->id_cidade);
		if ($this->isColumnModified(TbcidadePeer::DESCRICAO)) $criteria->add(TbcidadePeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbcidadePeer::ID_ESTADO)) $criteria->add(TbcidadePeer::ID_ESTADO, $this->id_estado);
		if ($this->isColumnModified(TbcidadePeer::ID_PAIS)) $criteria->add(TbcidadePeer::ID_PAIS, $this->id_pais);
		if ($this->isColumnModified(TbcidadePeer::CREATED_AT)) $criteria->add(TbcidadePeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbcidadePeer::UPDATED_AT)) $criteria->add(TbcidadePeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbcidadePeer::CREATED_BY)) $criteria->add(TbcidadePeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbcidadePeer::UPDATED_BY)) $criteria->add(TbcidadePeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbcidadePeer::ID_CIDADE, $this->id_cidade);
	...
	/**
	 * Generic method to set the primary key (id_cidade column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbcidade (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getTbcampuss() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addTbcampus($relObj->copy($deepCopy));
				}
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbcidade Clone of current object.
	 * @throws     PropelException
	 */
	...
	{
		if (self::$peer === null) {
			self::$peer = new TbcidadePeer();
		}
		return self::$peer;
	}

	/**
	 * Declares an association between this object and a Tbestado object.
	 *
	 * @param      Tbestado $v
	 * @return     Tbcidade The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setTbestado(Tbestado $v = null)
	{
		if ($v === null) {
			$this->setIdEstado(NULL);
		} else {
			$this->setIdEstado($v->getIdEstado());
		}

		$this->aTbestado = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Tbestado object, it will not be re-added.
		if ($v !== null) {
			$v->addTbcidade($this);
		}
	...
	/**
	 * Get the associated Tbestado object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Tbestado The associated Tbestado object.
	 * @throws     PropelException
	 */
	public function getTbestado(PropelPDO $con = null)
	{
		if ($this->aTbestado === null && ($this->id_estado !== null)) {
			$this->aTbestado = TbestadoPeer::retrieveByPk($this->id_estado);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTbestado->addTbcidades($this);
			 */
		}
		return $this->aTbestado;
	}
	...
	{
		if ($this->aTbpais === null && ($this->id_pais !== null)) {
			$this->aTbpais = TbpaisPeer::retrieveByPk($this->id_pais);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTbpais->addTbcidades($this);
			 */
		}
		return $this->aTbpais;
	}
	 ...
	 * Otherwise if this Tbcidade has previously been saved, it will retrieve
	 * related Tbalunomatriculas from storage. If this Tbcidade is new, it will return
		...
		if ($this->collTbalunomatriculas === null) {
			if ($this->isNew()) {
			   $this->collTbalunomatriculas = array();
				...
				$criteria->add(TbalunomatriculaPeer::NATURALIDADE, $this->id_cidade);
	 ...
	 * Otherwise if this Tbcidade is new, it will return
	 * an empty collection; or if this Tbcidade has previously
	 * been saved, it will retrieve related Tbalunomatriculas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbcidade.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbcidade has previously been saved, it will retrieve
	 * related Tbalunobackups from storage. If this Tbcidade is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunobackups === null) {
			if ($this->isNew()) {
			   $this->collTbalunobackups = array();
				...
				$criteria->add(TbalunobackupPeer::NATURALIDADE, $this->id_cidade);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbcidade has previously been saved, it will retrieve
	 * related Tbalunos from storage. If this Tbcidade is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunos === null) {
			if ($this->isNew()) {
			   $this->collTbalunos = array();
				...
				$criteria->add(TbalunoPeer::NATURALIDADE, $this->id_cidade);
	...
	/**
	 * Clears out the collTbcampuss collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addTbcampuss()
	 */
	public function clearTbcampuss()
	{
		$this->collTbcampuss = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTbcampuss collection (array).
	 *
	 * By default this just sets the collTbcampuss collection to an empty array (like clearcollTbcampuss());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initTbcampuss()
	{
		$this->collTbcampuss = array();
	}

	/**
	 * Gets an array of Tbcampus objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbcidade has previously been saved, it will retrieve
	 * related Tbcampuss from storage. If this Tbcidade is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Tbcampus[]
	 * @throws     PropelException
	 */
	public function getTbcampuss($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbcidadePeer::DATABASE_NAME);
		}
		...
		if ($this->collTbcampuss === null) {
			if ($this->isNew()) {
			   $this->collTbcampuss = array();
				...
				$criteria->add(TbcampusPeer::ID_CIDADE, $this->id_cidade);

				TbcampusPeer::addSelectColumns($criteria);
				$this->collTbcampuss = TbcampusPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				TbcampusPeer::addSelectColumns($criteria);
				if (!isset($this->lastTbcampusCriteria) || !$this->lastTbcampusCriteria->equals($criteria)) {
					$this->collTbcampuss = TbcampusPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTbcampusCriteria = $criteria;
		return $this->collTbcampuss;
	}

	/**
	 * Returns the number of related Tbcampus objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Tbcampus objects.
	 * @throws     PropelException
	 */
	public function countTbcampuss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbcidadePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collTbcampuss === null) {
			if ($this->isNew()) {
				...
				$count = TbcampusPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastTbcampusCriteria) || !$this->lastTbcampusCriteria->equals($criteria)) {
					...
					$count = count($this->collTbcampuss);
				}
			} else {
				$count = count($this->collTbcampuss);
			}
	...
	/**
	 * Method called to associate a Tbcampus object to this object
	 * through the Tbcampus foreign key attribute.
	 *
	 * @param      Tbcampus $l Tbcampus
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTbcampus(Tbcampus $l)
	{
		if ($this->collTbcampuss === null) {
			$this->initTbcampuss();
		}
		if (!in_array($l, $this->collTbcampuss, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTbcampuss, $l);
			$l->setTbcidade($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbcidade has previously been saved, it will retrieve
	 * related Tblogradouros from storage. If this Tbcidade is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTblogradouros === null) {
			if ($this->isNew()) {
			   $this->collTblogradouros = array();
				...
				$criteria->add(TblogradouroPeer::ID_CIDADE, $this->id_cidade);
	 ...
	 * actually need in Tbcidade.
	 */
	public function getTblogradourosJoinTbbairro($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TbcidadePeer::DATABASE_NAME);
		}
		...
		if ($this->collTblogradouros === null) {
			if ($this->isNew()) {
				...
				$this->collTblogradouros = TblogradouroPeer::doSelectJoinTbbairro($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			...
			if ($this->collTbcampuss) {
				foreach ((array) $this->collTbcampuss as $o) {
					$o->clearAllReferences($deep);
				}
			}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbcidade:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbcidade::%s', $method));
	  }
