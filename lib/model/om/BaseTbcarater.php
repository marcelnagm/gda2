...
/**
 * Base class that represents a row from the 'tbcarater' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbcarater extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbcarater The current object (for fluent API support)
	 */
	public function setIdCarater($v)
	{
		...
		if ($this->id_carater !== $v) {
			$this->id_carater = $v;
			$this->modifiedColumns[] = TbcaraterPeer::ID_CARATER;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbcaraterPeer::DESCRICAO;
		}
	...
	public function setSucinto($v)
	{
		...
		if ($this->sucinto !== $v) {
			$this->sucinto = $v;
			$this->modifiedColumns[] = TbcaraterPeer::SUCINTO;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbcaraterPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbcaraterPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbcaraterPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbcaraterPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_carater = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 7; // 7 = TbcaraterPeer::NUM_COLUMNS - TbcaraterPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbcarater object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbcaraterPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbcarater:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbcaraterPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbcarater:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbcarater:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbcaraterPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbcaraterPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbcarater:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbcaraterPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbcaraterPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdCarater($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbcaraterPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbcaraterPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbcaraterPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbcaraterPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdCarater(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdCarater($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbcaraterPeer::ID_CARATER)) $criteria->add(TbcaraterPeer::ID_CARATER, $this->id_carater);
		if ($this->isColumnModified(TbcaraterPeer::DESCRICAO)) $criteria->add(TbcaraterPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbcaraterPeer::SUCINTO)) $criteria->add(TbcaraterPeer::SUCINTO, $this->sucinto);
		if ($this->isColumnModified(TbcaraterPeer::CREATED_AT)) $criteria->add(TbcaraterPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbcaraterPeer::UPDATED_AT)) $criteria->add(TbcaraterPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbcaraterPeer::CREATED_BY)) $criteria->add(TbcaraterPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbcaraterPeer::UPDATED_BY)) $criteria->add(TbcaraterPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbcaraterPeer::ID_CARATER, $this->id_carater);
	...
	/**
	 * Generic method to set the primary key (id_carater column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbcarater (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdCarater(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbcarater Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TbcaraterPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TbcaraterPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tbcarater has previously been saved, it will retrieve
	 * related Tbcurriculodisciplinass from storage. If this Tbcarater is new, it will return
		...
		if ($this->collTbcurriculodisciplinass === null) {
			if ($this->isNew()) {
			   $this->collTbcurriculodisciplinass = array();
				...
				$criteria->add(TbcurriculodisciplinasPeer::ID_CARATER, $this->id_carater);
	 ...
	 * Otherwise if this Tbcarater is new, it will return
	 * an empty collection; or if this Tbcarater has previously
	 * been saved, it will retrieve related Tbcurriculodisciplinass from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbcarater.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbcarater:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbcarater::%s', $method));
	  }
