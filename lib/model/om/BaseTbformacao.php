...
/**
 * Base class that represents a row from the 'tbformacao' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbformacao extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbformacao The current object (for fluent API support)
	 */
	public function setIdFormacao($v)
	{
		...
		if ($this->id_formacao !== $v) {
			$this->id_formacao = $v;
			$this->modifiedColumns[] = TbformacaoPeer::ID_FORMACAO;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbformacaoPeer::DESCRICAO;
		}
	...
	public function setAbreviatura($v)
	{
		...
		if ($this->abreviatura !== $v) {
			$this->abreviatura = $v;
			$this->modifiedColumns[] = TbformacaoPeer::ABREVIATURA;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbformacaoPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbformacaoPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbformacaoPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbformacaoPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_formacao = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 7; // 7 = TbformacaoPeer::NUM_COLUMNS - TbformacaoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbformacao object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbformacaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbformacao:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbformacaoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbformacao:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbformacao:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbformacaoPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbformacaoPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbformacao:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbformacaoPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbformacaoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdFormacao($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbformacaoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbformacaoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbformacaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbformacaoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdFormacao(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdFormacao($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbformacaoPeer::ID_FORMACAO)) $criteria->add(TbformacaoPeer::ID_FORMACAO, $this->id_formacao);
		if ($this->isColumnModified(TbformacaoPeer::DESCRICAO)) $criteria->add(TbformacaoPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbformacaoPeer::ABREVIATURA)) $criteria->add(TbformacaoPeer::ABREVIATURA, $this->abreviatura);
		if ($this->isColumnModified(TbformacaoPeer::CREATED_AT)) $criteria->add(TbformacaoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbformacaoPeer::UPDATED_AT)) $criteria->add(TbformacaoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbformacaoPeer::CREATED_BY)) $criteria->add(TbformacaoPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbformacaoPeer::UPDATED_BY)) $criteria->add(TbformacaoPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbformacaoPeer::ID_FORMACAO, $this->id_formacao);
	...
	/**
	 * Generic method to set the primary key (id_formacao column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbformacao (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdFormacao(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbformacao Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TbformacaoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TbformacaoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tbformacao has previously been saved, it will retrieve
	 * related Tbcursoversaos from storage. If this Tbformacao is new, it will return
		...
		if ($this->collTbcursoversaos === null) {
			if ($this->isNew()) {
			   $this->collTbcursoversaos = array();
				...
				$criteria->add(TbcursoversaoPeer::ID_FORMACAO, $this->id_formacao);
	 ...
	 * Otherwise if this Tbformacao is new, it will return
	 * an empty collection; or if this Tbformacao has previously
	 * been saved, it will retrieve related Tbcursoversaos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbformacao.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbformacao has previously been saved, it will retrieve
	 * related Tbprofessors from storage. If this Tbformacao is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbprofessors === null) {
			if ($this->isNew()) {
			   $this->collTbprofessors = array();
				...
				$criteria->add(TbprofessorPeer::ID_FORMACAO, $this->id_formacao);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbformacao:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbformacao::%s', $method));
	  }
