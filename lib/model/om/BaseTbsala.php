...
/**
 * Base class that represents a row from the 'tbsala' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbsala extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the bloco field.
	 * @var        string
	 */
	protected $bloco;

	/**
	 * The value for the capacidade field.
	 * @var        int
	 */
	...
	/**
	 * Get the [capacidade] column value.
	 * 
	 * @return     int
	 */
	 ...
	 * @return     Tbsala The current object (for fluent API support)
	 */
	public function setIdSala($v)
	{
		...
		if ($this->id_sala !== $v) {
			$this->id_sala = $v;
			$this->modifiedColumns[] = TbsalaPeer::ID_SALA;
		}
	...
	/**
	 * Set the value of [bloco] column.
	 * 
	 * @param      string $v new value
	 * @return     Tbsala The current object (for fluent API support)
	 */
	public function setBloco($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->bloco !== $v) {
			$this->bloco = $v;
			$this->modifiedColumns[] = TbsalaPeer::BLOCO;
		}
	...
	/**
	 * Set the value of [capacidade] column.
	 * 
	 * @param      int $v new value
	 * @return     Tbsala The current object (for fluent API support)
	 */
	public function setCapacidade($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->capacidade !== $v) {
			$this->capacidade = $v;
			$this->modifiedColumns[] = TbsalaPeer::CAPACIDADE;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbsalaPeer::DESCRICAO;
		}
	...
	public function setIdCampus($v)
	{
		...
		if ($this->id_campus !== $v) {
			$this->id_campus = $v;
			$this->modifiedColumns[] = TbsalaPeer::ID_CAMPUS;
		}
	...
	public function setNumero($v)
	{
		...
		if ($this->numero !== $v) {
			$this->numero = $v;
			$this->modifiedColumns[] = TbsalaPeer::NUMERO;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbsalaPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbsalaPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbsalaPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbsalaPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_sala = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->bloco = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->capacidade = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->descricao = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->id_campus = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->numero = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 10; // 10 = TbsalaPeer::NUM_COLUMNS - TbsalaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbsala object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbsalaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbsala:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbsalaPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbsala:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbsala:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbsalaPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbsalaPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbsala:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbsalaPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbsalaPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdSala($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbsalaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbsalaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbsalaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbsalaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdSala(),
			$keys[1] => $this->getBloco(),
			$keys[2] => $this->getCapacidade(),
			$keys[3] => $this->getDescricao(),
			$keys[4] => $this->getIdCampus(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdSala($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setBloco($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setCapacidade($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setDescricao($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setIdCampus($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbsalaPeer::ID_SALA)) $criteria->add(TbsalaPeer::ID_SALA, $this->id_sala);
		if ($this->isColumnModified(TbsalaPeer::BLOCO)) $criteria->add(TbsalaPeer::BLOCO, $this->bloco);
		if ($this->isColumnModified(TbsalaPeer::CAPACIDADE)) $criteria->add(TbsalaPeer::CAPACIDADE, $this->capacidade);
		if ($this->isColumnModified(TbsalaPeer::DESCRICAO)) $criteria->add(TbsalaPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbsalaPeer::ID_CAMPUS)) $criteria->add(TbsalaPeer::ID_CAMPUS, $this->id_campus);
		if ($this->isColumnModified(TbsalaPeer::NUMERO)) $criteria->add(TbsalaPeer::NUMERO, $this->numero);
		if ($this->isColumnModified(TbsalaPeer::CREATED_AT)) $criteria->add(TbsalaPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbsalaPeer::UPDATED_AT)) $criteria->add(TbsalaPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbsalaPeer::CREATED_BY)) $criteria->add(TbsalaPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbsalaPeer::UPDATED_BY)) $criteria->add(TbsalaPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbsalaPeer::ID_SALA, $this->id_sala);
	...
	/**
	 * Generic method to set the primary key (id_sala column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbsala (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBloco($this->bloco);

		$copyObj->setCapacidade($this->capacidade);
		...
		$copyObj->setIdSala(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbsala Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getTbcampus(PropelPDO $con = null)
	{
		if ($this->aTbcampus === null && ($this->id_campus !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTbcampus->addTbsalas($this);
			 */
		}
	 ...
	 * Otherwise if this Tbsala has previously been saved, it will retrieve
	 * related Tbofertas from storage. If this Tbsala is new, it will return
		...
		if ($this->collTbofertas === null) {
			if ($this->isNew()) {
			   $this->collTbofertas = array();
				...
				$criteria->add(TbofertaPeer::ID_SALA, $this->id_sala);
	 ...
	 * Otherwise if this Tbsala is new, it will return
	 * an empty collection; or if this Tbsala has previously
	 * been saved, it will retrieve related Tbofertas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbsala.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbsala:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbsala::%s', $method));
	  }
