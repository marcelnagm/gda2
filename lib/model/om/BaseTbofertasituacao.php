...
/**
 * Base class that represents a row from the 'tbofertasituacao' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbofertasituacao extends BaseObject  implements Persistent {
	...
	const PEER = 'TbofertasituacaoPeer';
	 ...
	 * @return     Tbofertasituacao The current object (for fluent API support)
	 */
	public function setIdSituacao($v)
	{
		...
		if ($this->id_situacao !== $v) {
			$this->id_situacao = $v;
			$this->modifiedColumns[] = TbofertasituacaoPeer::ID_SITUACAO;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbofertasituacaoPeer::DESCRICAO;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbofertasituacaoPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbofertasituacaoPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbofertasituacaoPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbofertasituacaoPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = TbofertasituacaoPeer::NUM_COLUMNS - TbofertasituacaoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbofertasituacao object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbofertasituacaoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbofertasituacao:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbofertasituacaoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbofertasituacao:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbofertasituacao:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbofertasituacaoPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbofertasituacaoPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbofertasituacao:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbofertasituacaoPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbofertasituacaoPeer::doInsert($this, $con);
					...
					$affectedRows += TbofertasituacaoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbofertasituacaoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbofertasituacaoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbofertasituacaoPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbofertasituacaoPeer::ID_SITUACAO)) $criteria->add(TbofertasituacaoPeer::ID_SITUACAO, $this->id_situacao);
		if ($this->isColumnModified(TbofertasituacaoPeer::DESCRICAO)) $criteria->add(TbofertasituacaoPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbofertasituacaoPeer::CREATED_AT)) $criteria->add(TbofertasituacaoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbofertasituacaoPeer::UPDATED_AT)) $criteria->add(TbofertasituacaoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbofertasituacaoPeer::CREATED_BY)) $criteria->add(TbofertasituacaoPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbofertasituacaoPeer::UPDATED_BY)) $criteria->add(TbofertasituacaoPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbofertasituacaoPeer::ID_SITUACAO, $this->id_situacao);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbofertasituacao (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbofertasituacao Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TbofertasituacaoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TbofertasituacaoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tbofertasituacao has previously been saved, it will retrieve
	 * related Tbofertas from storage. If this Tbofertasituacao is new, it will return
		...
		if ($this->collTbofertas === null) {
			if ($this->isNew()) {
			   $this->collTbofertas = array();
				...
				$criteria->add(TbofertaPeer::ID_SITUACAO, $this->id_situacao);
	 ...
	 * Otherwise if this Tbofertasituacao is new, it will return
	 * an empty collection; or if this Tbofertasituacao has previously
	 * been saved, it will retrieve related Tbofertas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbofertasituacao.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbofertasituacao:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbofertasituacao::%s', $method));
	  }
