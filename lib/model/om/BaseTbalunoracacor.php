...
/**
 * Base class that represents a row from the 'tbaluno_racacor' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbalunoracacor extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbalunoracacor The current object (for fluent API support)
	 */
	public function setIdRaca($v)
	{
		...
		if ($this->id_raca !== $v) {
			$this->id_raca = $v;
			$this->modifiedColumns[] = TbalunoracacorPeer::ID_RACA;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbalunoracacorPeer::DESCRICAO;
		}
	...
	public function setSiglaPingifes($v)
	{
		...
		if ($this->sigla_pingifes !== $v) {
			...
			$this->modifiedColumns[] = TbalunoracacorPeer::SIGLA_PINGIFES;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbalunoracacorPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbalunoracacorPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbalunoracacorPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbalunoracacorPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_raca = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 7; // 7 = TbalunoracacorPeer::NUM_COLUMNS - TbalunoracacorPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbalunoracacor object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbalunoracacorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbalunoracacor:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbalunoracacorPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbalunoracacor:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbalunoracacor:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbalunoracacorPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbalunoracacorPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbalunoracacor:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbalunoracacorPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbalunoracacorPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdRaca($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbalunoracacorPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbalunoracacorPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbalunoracacorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbalunoracacorPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdRaca(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdRaca($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbalunoracacorPeer::ID_RACA)) $criteria->add(TbalunoracacorPeer::ID_RACA, $this->id_raca);
		if ($this->isColumnModified(TbalunoracacorPeer::DESCRICAO)) $criteria->add(TbalunoracacorPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbalunoracacorPeer::SIGLA_PINGIFES)) $criteria->add(TbalunoracacorPeer::SIGLA_PINGIFES, $this->sigla_pingifes);
		if ($this->isColumnModified(TbalunoracacorPeer::CREATED_AT)) $criteria->add(TbalunoracacorPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbalunoracacorPeer::UPDATED_AT)) $criteria->add(TbalunoracacorPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbalunoracacorPeer::CREATED_BY)) $criteria->add(TbalunoracacorPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbalunoracacorPeer::UPDATED_BY)) $criteria->add(TbalunoracacorPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbalunoracacorPeer::ID_RACA, $this->id_raca);
	...
	/**
	 * Generic method to set the primary key (id_raca column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbalunoracacor (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdRaca(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbalunoracacor Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TbalunoracacorPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TbalunoracacorPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tbalunoracacor has previously been saved, it will retrieve
	 * related Tbalunomatriculas from storage. If this Tbalunoracacor is new, it will return
		...
		if ($this->collTbalunomatriculas === null) {
			if ($this->isNew()) {
			   $this->collTbalunomatriculas = array();
				...
				$criteria->add(TbalunomatriculaPeer::ID_RACA, $this->id_raca);
	 ...
	 * Otherwise if this Tbalunoracacor is new, it will return
	 * an empty collection; or if this Tbalunoracacor has previously
	 * been saved, it will retrieve related Tbalunomatriculas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbalunoracacor.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbalunoracacor has previously been saved, it will retrieve
	 * related Tbalunobackups from storage. If this Tbalunoracacor is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunobackups === null) {
			if ($this->isNew()) {
			   $this->collTbalunobackups = array();
				...
				$criteria->add(TbalunobackupPeer::ID_RACA, $this->id_raca);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbalunoracacor has previously been saved, it will retrieve
	 * related Tbalunos from storage. If this Tbalunoracacor is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunos === null) {
			if ($this->isNew()) {
			   $this->collTbalunos = array();
				...
				$criteria->add(TbalunoPeer::ID_RACA, $this->id_raca);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbalunoracacor:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbalunoracacor::%s', $method));
	  }
