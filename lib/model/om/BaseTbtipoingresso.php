...
/**
 * Base class that represents a row from the 'tbtipoingresso' table.
 *
 * 
 *
 ...
 */
abstract class BaseTbtipoingresso extends BaseObject  implements Persistent {
	 ...
	 * @return     Tbtipoingresso The current object (for fluent API support)
	 */
	public function setIdTipoIngresso($v)
	{
		...
		if ($this->id_tipo_ingresso !== $v) {
			...
			$this->modifiedColumns[] = TbtipoingressoPeer::ID_TIPO_INGRESSO;
		}
	...
	public function setDescricao($v)
	{
		...
		if ($this->descricao !== $v) {
			$this->descricao = $v;
			$this->modifiedColumns[] = TbtipoingressoPeer::DESCRICAO;
		}
	...
	public function setSiglaPingifes($v)
	{
		...
		if ($this->sigla_pingifes !== $v) {
			...
			$this->modifiedColumns[] = TbtipoingressoPeer::SIGLA_PINGIFES;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbtipoingressoPeer::CREATED_AT;
			}
	...
	public function setUpdatedAt($v)
	{
		...
		if ( $this->updated_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TbtipoingressoPeer::UPDATED_AT;
			}
		} // if either are not null
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = TbtipoingressoPeer::CREATED_BY;
		}
	...
	public function setUpdatedBy($v)
	{
		...
		if ($this->updated_by !== $v) {
			$this->updated_by = $v;
			$this->modifiedColumns[] = TbtipoingressoPeer::UPDATED_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_tipo_ingresso = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 7; // 7 = TbtipoingressoPeer::NUM_COLUMNS - TbtipoingressoPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tbtipoingresso object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TbtipoingressoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTbtipoingresso:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TbtipoingressoPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbtipoingresso:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTbtipoingresso:save:pre') as $callable)
			{
			...
			if ($this->isModified() && !$this->isColumnModified(TbtipoingressoPeer::UPDATED_AT))
			{
			...
			if ($isInsert) {
				...
				// symfony_timestampable behavior
				if (!$this->isColumnModified(TbtipoingressoPeer::CREATED_AT))
				{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTbtipoingresso:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				$con->commit();
				TbtipoingressoPeer::addInstanceToPool($this);
				return $affectedRows;
			}
		} catch (PropelException $e) {
			$con->rollBack();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TbtipoingressoPeer::doInsert($this, $con);
					$affectedRows += 1; // we are assuming that there is only 1 row per doInsert() which
										 // should always be true here (even though technically
										 // BasePeer::doInsert() can insert multiple rows).

					$this->setIdTipoIngresso($pk);  //[IMV] update autoincrement primary key

					$this->setNew(false);
				} else {
					$affectedRows += TbtipoingressoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TbtipoingressoPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TbtipoingressoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TbtipoingressoPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdTipoIngresso(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdTipoIngresso($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TbtipoingressoPeer::ID_TIPO_INGRESSO)) $criteria->add(TbtipoingressoPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
		if ($this->isColumnModified(TbtipoingressoPeer::DESCRICAO)) $criteria->add(TbtipoingressoPeer::DESCRICAO, $this->descricao);
		if ($this->isColumnModified(TbtipoingressoPeer::SIGLA_PINGIFES)) $criteria->add(TbtipoingressoPeer::SIGLA_PINGIFES, $this->sigla_pingifes);
		if ($this->isColumnModified(TbtipoingressoPeer::CREATED_AT)) $criteria->add(TbtipoingressoPeer::CREATED_AT, $this->created_at);
		if ($this->isColumnModified(TbtipoingressoPeer::UPDATED_AT)) $criteria->add(TbtipoingressoPeer::UPDATED_AT, $this->updated_at);
		if ($this->isColumnModified(TbtipoingressoPeer::CREATED_BY)) $criteria->add(TbtipoingressoPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(TbtipoingressoPeer::UPDATED_BY)) $criteria->add(TbtipoingressoPeer::UPDATED_BY, $this->updated_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TbtipoingressoPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
	...
	/**
	 * Generic method to set the primary key (id_tipo_ingresso column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tbtipoingresso (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdTipoIngresso(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tbtipoingresso Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TbtipoingressoPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TbtipoingressoPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this Tbtipoingresso has previously been saved, it will retrieve
	 * related Tbalunomatriculas from storage. If this Tbtipoingresso is new, it will return
		...
		if ($this->collTbalunomatriculas === null) {
			if ($this->isNew()) {
			   $this->collTbalunomatriculas = array();
				...
				$criteria->add(TbalunomatriculaPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
	 ...
	 * Otherwise if this Tbtipoingresso is new, it will return
	 * an empty collection; or if this Tbtipoingresso has previously
	 * been saved, it will retrieve related Tbalunomatriculas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tbtipoingresso.
	 */
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbtipoingresso has previously been saved, it will retrieve
	 * related Tbalunobackups from storage. If this Tbtipoingresso is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunobackups === null) {
			if ($this->isNew()) {
			   $this->collTbalunobackups = array();
				...
				$criteria->add(TbalunobackupPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbtipoingresso has previously been saved, it will retrieve
	 * related Tbloadalunos from storage. If this Tbtipoingresso is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbloadalunos === null) {
			if ($this->isNew()) {
			   $this->collTbloadalunos = array();
				...
				$criteria->add(TbloadalunoPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Tbtipoingresso has previously been saved, it will retrieve
	 * related Tbalunos from storage. If this Tbtipoingresso is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collTbalunos === null) {
			if ($this->isNew()) {
			   $this->collTbalunos = array();
				...
				$criteria->add(TbalunoPeer::ID_TIPO_INGRESSO, $this->id_tipo_ingresso);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTbtipoingresso:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTbtipoingresso::%s', $method));
	  }
