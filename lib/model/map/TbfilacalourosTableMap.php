...
/**
 * This class defines the structure of the 'tbfilacalouros' table.
 *
 *
 ...
 */
class TbfilacalourosTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.TbfilacalourosTableMap';
	...
	{
	  // attributes
		$this->setName('tbfilacalouros');
		$this->setPhpName('Tbfilacalouros');
		$this->setClassname('Tbfilacalouros');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		$this->setPrimaryKeyMethodInfo('tbfilacalouros_id_fila_calouros_seq');
		// columns
		$this->addPrimaryKey('ID_FILA_CALOUROS', 'IdFilaCalouros', 'INTEGER', true, null, null);
