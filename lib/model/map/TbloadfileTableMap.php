...
/**
 * This class defines the structure of the 'tbloadfile' table.
 *
 *
 ...
 */
class TbloadfileTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.TbloadfileTableMap';
	...
	{
	  // attributes
		$this->setName('tbloadfile');
		$this->setPhpName('Tbloadfile');
		$this->setClassname('Tbloadfile');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		$this->setPrimaryKeyMethodInfo('tbloadfile_id_seq');
		// columns
