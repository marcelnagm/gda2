...
/**
 * This class defines the structure of the 'tbvagas' table.
 *
 *
 ...
 */
class TbvagasTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.TbvagasTableMap';
	...
	{
	  // attributes
		$this->setName('tbvagas');
		$this->setPhpName('Tbvagas');
		$this->setClassname('Tbvagas');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		$this->setPrimaryKeyMethodInfo('tbvagas_id_vagas_seq');
		// columns
		$this->addPrimaryKey('ID_VAGAS', 'IdVagas', 'INTEGER', true, null, null);
		...
		$this->addColumn('VAGAS_SEGUNDA_OPCAO', 'VagasSegundaOpcao', 'INTEGER', true, null, 0);
