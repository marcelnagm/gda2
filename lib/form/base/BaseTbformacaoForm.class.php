...
/**
 * Tbformacao form base class.
 *
 * @method Tbformacao getObject() Returns the current form's model object
 *
 * @package    derca
 * @subpackage form
 ...
 */
abstract class BaseTbformacaoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'id_formacao' => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      ...
      'abreviatura' => new sfValidatorString(array('max_length' => 10, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('tbformacao[%s]');
