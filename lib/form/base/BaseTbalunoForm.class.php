...
/**
 * Tbaluno form base class.
 *
 * @method Tbaluno getObject() Returns the current form's model object
 *
 * @package    derca
 * @subpackage form
 ...
 */
abstract class BaseTbalunoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'enade'                 => new sfWidgetFormInputCheckbox(),
    ));
    ...
    $this->setValidators(array(
      ...
      'rg_org_exped'          => new sfValidatorString(array('max_length' => 20, 'required' => false)),
      ...
      'enade'                 => new sfValidatorBoolean(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('tbaluno[%s]');
