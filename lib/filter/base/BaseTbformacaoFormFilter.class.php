...
/**
 * Tbformacao filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbformacaoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbformacao_filters[%s]');
