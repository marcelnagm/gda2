...
/**
 * Tbturno filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbturnoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      'descricao'    => new sfWidgetFormFilterInput(),
      'hora_inicial' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'hora_final'   => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->widgetSchema->setNameFormat('tbturno_filters[%s]');
