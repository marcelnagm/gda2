...
/**
 * Tbvagas filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbvagasFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'vagas_segunda_opcao' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'vagas_segunda_opcao' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('tbvagas_filters[%s]');
