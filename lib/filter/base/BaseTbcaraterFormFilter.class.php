...
/**
 * Tbcarater filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbcaraterFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbcarater_filters[%s]');
