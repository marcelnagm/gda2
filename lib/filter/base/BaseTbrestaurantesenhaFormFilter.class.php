...
/**
 * Tbrestaurantesenha filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbrestaurantesenhaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbrestaurantesenha_filters[%s]');
