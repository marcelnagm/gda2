...
/**
 * Tbalunosituacao filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbalunosituacaoFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbalunosituacao_filters[%s]');
