...
/**
 * Tbalunoracacor filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbalunoracacorFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbalunoracacor_filters[%s]');
