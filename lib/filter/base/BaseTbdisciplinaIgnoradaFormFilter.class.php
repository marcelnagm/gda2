...
/**
 * TbdisciplinaIgnorada filter form base class.
 *
 * @package    derca
 * @subpackage filter
 ...
 */
abstract class BaseTbdisciplinaIgnoradaFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tbdisciplina_ignorada_filters[%s]');
