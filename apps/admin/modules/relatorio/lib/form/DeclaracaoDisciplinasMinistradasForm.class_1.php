...
class DeclaracaoDisciplinasMinistradasForm extends RelatorioForm {
    ...
    function executaRelatorio() {
        ...
        $this->templateVars['professor']    = $professor->getNome();
        $this->templateVars['nivel']        = 'Graduação'; # TODO: obter o nivel de formação no banco
        $this->templateVars['departamento'] = ($professor->getTbsetor() instanceof Tbsetor) ? $professor->getTbsetor()->getDescricao() : '(Setor não definido)';
        $this->templateVars['data']         = strftime(" %d de %B de %Y");
