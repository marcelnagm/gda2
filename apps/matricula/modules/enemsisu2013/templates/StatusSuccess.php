...
<tr>
    <td align="center">
        <a href="<?php echo url_for1('enemsisu2013/GerarFicha'); ?>">
    ...
    <td>
        <a href="<?php echo url_for1('enemsisu2013/Imprimir'); ?>" target="_blank">
            <div align="center" style="
                 border:3px solid #999999;
                 width:300px;
                 height:100px;
...
<br><br>
<h3 style="text-align: center"><a href="<?php echo url_for1('enemsisu2013/index'); ?>">Voltar ao Menu</a></h3>