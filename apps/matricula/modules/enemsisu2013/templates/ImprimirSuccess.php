    ...
    <BODY LANG="pt-BR" TEXT="#000000" LINK="#0000ff" DIR="LTR" onload="window.print()">
        ...
        <div style="width: 17cm" align="center">
            ...
            <P ALIGN=JUSTIFY STYLE="margin-bottom: 0cm; line-height: 150%"><FONT FACE="Arial, sans-serif" STYLE="font-size: 10pt">
                    <?php echo TbavisoPeer::getText(8); ?>
                </FONT></P>
            ...
            <ul><FONT FACE="Arial, sans-serif"><FONT SIZE=1 STYLE="font-size: 10pt">
                ...
                <li><p align="justify" >Cópia e original de laudo médico emitido nos últimos doze meses
                        para deficientes reversíveis e sem limite de data de emissão para deficientes 
                        irreversíveis. O candidato será submetido à perícia médica da UFRR, exceto o 
                        candidato que apresentar laudo médico homologado por perito ou junta médica oficial;</p></li>
                <?php } ?>
