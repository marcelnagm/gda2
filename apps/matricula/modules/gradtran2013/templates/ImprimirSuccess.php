    ...
    <BODY LANG="pt-BR" TEXT="#000000" LINK="#0000ff" DIR="LTR" onload="window.print()">
        ...
        <div style="width: 17cm" align="center">
            <DIV align="center">
                <table cellpadding="0" cellspacing="5">
                    <tr>
                        ...
                        <td><IMG SRC="/matricula/images/ufrr.png" alt="figura2" WIDTH=80 HEIGHT=75 BORDER=0></td>
                    </tr>
                </table>
            ...
            <P ALIGN=JUSTIFY STYLE="margin-bottom: 0cm; line-height: 150%"><FONT FACE="Arial, sans-serif" STYLE="font-size: 10pt">
                    Comparecer<a href="#1">¹</a> durante os dias 11 e 12 de abril de 2013 no Departamento de Registro e
                    Controle Acadêmico - DERCA da Universidade Federal de Roraima, no horário
                    das 08h às 12h e das 14h às 18h, munido da documentação especificada abaixo para
                    o cadastramento, este comprovante e a ficha de aluno assinada.</FONT></P>
            ...
            <ul><FONT FACE="Arial, sans-serif"><FONT SIZE=1 STYLE="font-size: 10pt">
                <?php if (in_array($aluno->getIdTipoIngresso(), array(5))) { ?>
                <li><p align="justify" >Cópia e original do certificado de conclusão ou do diploma do curso superior;</p></li>
                <li><p align="justify" >Cópia e original do histórico escolar do ensino superior;</p></li>
                <?php } else { ?>
                ...
                <?php } ?>
                <?php if (in_array($aluno->getIdTipoIngresso(), array(13))) { ?>
                <li><p align="justify" >Comprovante de aproveitamento de créditos equivalente a 300 horas, no curso de origem;</p></li>
                <li><p align="justify" >Declaração de estar regularmente matriculado na instituição de origem;</p></li>
                <?php } ?>
