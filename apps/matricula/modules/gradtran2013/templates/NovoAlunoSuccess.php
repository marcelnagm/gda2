...
<?php if (isset($form)) { ?>
    ...
    <div id="sf_admin_container">
        ...
        <form action="<?php echo url_for1('gradtran2013/NovoAluno'); ?>" method="POST" onsubmit="return checkForm()">
            ...
            <?php } ?>
            <?php include_partial('gradtran2013/form_fields', array('tbaluno' => $form->getObject(), 'form' => $form, 'configuration' => $configuration)) ?>
                </div>
            <br>
...
?>
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <a href="<?php echo url_for1('gradtran2013/ShowAluno'); ?>" target="_blank">
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo url_for1('gradtran2013/NovoAluno'); ?>">
                                    <div align="center" style="
                                         border:3px solid #999999;
                                         width:300px;
                                         height:100px;
                            ...
                            <td>
                                <a href="<?php echo url_for1('gradtran2013/FinalizarMatricula'); ?>">
                                    <div align="center" style="
                                         border:3px solid #999999;
                                         width:300px;
                                         height:100px;
