...
<tr>
    <td align="center">
        <a href="<?php echo url_for1('admin/GerarFicha'); ?>">
    ...
    <td>
        <a href="<?php echo url_for1('admin/Imprimir'); ?>" target="_blank">
            <div align="center" style="
                 border:3px solid #999999;
                 width:300px;
                 height:100px;
...
<br><br>
<h3 style="text-align: center"><a href="<?php echo url_for1('admin/index'); ?>">Voltar ao Menu</a></h3>