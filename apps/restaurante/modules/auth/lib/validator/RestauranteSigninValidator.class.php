 ...
 */
class RestauranteSigninValidator extends sfValidatorBase {
    /**
	...
	if(empty($values['matricula'])) return null;
        ...
        try {
            ...
            $c = new Criteria();
            $c->add(TbrestauranteloginPeer::MATRICULA, $values['matricula']);
            $aluno = TbrestauranteloginPeer::doSelectOne($c);

            if( ! $aluno instanceof Tbrestaurantelogin ) {
                throw new Exception();
            }
