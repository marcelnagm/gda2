...
class CadastroSenhaValidator extends sfValidatorBase {
    ...
    protected function doClean($values) {
        ...
        if ( ! $aluno ) throw new sfValidatorError($this, 'invalid');

        $c = new Criteria();
        $c->add(TbalunosenhaPeer::MATRICULA, $values['matricula']);
        $senha = TbalunosenhaPeer::doSelectOne($c);
        ...
        if( $values['matricula'] == $aluno->getMatricula() ) {
            // return values
