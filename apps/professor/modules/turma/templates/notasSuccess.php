...
<?php include_component('turma','info', array( 'id_turma' => $tbturma->getIdTurma() )) ?>
...
<div class="info">
    ...
    <form name="frm_n_notas" method="POST" action="<?php echo url_for('@form_nnotas') ?>" onsubmit="return validaFormNNotas(<?php echo $tbturma->getNNotas() ?>)">
        <input type="hidden" name="id" value="<?php echo $tbturma->getIdTurma() ?>" />
    ...
    <span class="art-button-wrapper">
        <span class="l"> </span>
        <span class="r"> </span>
        <a class="imprimir" target="_blank" href="?layout=impressao">Imprimir</a>
    </span>
</div>
<br />
