...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    <head>
        ...
        <script type="text/javascript" src="/professor/js/fixlayout.js"></script>
                ...
                <div class="art-Sheet-body">
                    <div class="art-Header">
                        ...
                        <div class="user-info-box">
                            <a class="dados-pessoais" href="<?php echo url_for('dadospessoais/index') ?>"><?php echo $professor->getNome() ?></a>
                            <a class="sair" href="<?php echo url_for('@auth_signout') ?>">
                                    <?php echo __('Logout') ?>
                            </a>
                    </div>
                        <?php endif ?>
                    ...
                    <div class="art-nav">
                        ...
                        <ul id="nav-one" class="nav art-menu">
                            ...
                            <li>
                                <a class="turma" href="<?php echo url_for('turma/index') ?>">
                                    <span class="l"></span>
                                    <span class="r"></span>
                                    <span class="t">Lista de turmas</span>
                                </a>
                            </li>
                            <?php if ($sf_user->getAttribute('professor')->getCoordenador()){ ?>
                            <li>
                                <a class="coordenador" >
                                    <span class="l"></span>
                                    <span class="r"></span>
                                    <span class="t">Coordenador</span>
                                </a>
                                <ul>
                                    <li>
                                        <a class="art-menu" href="<?php echo url_for('relatorio/index') ?>">Lista de Alunos do Curso</a>
                                    </li>
                                    <li>
                                        <a class="art-menu" href="<?php echo url_for('ofertacoordenador/index') ?>">Lista de Ofertas Cadastradas</a>
                                    </li>
                                    <li>
                                        <a class="art-menu" href="<?php echo url_for('demandas/index') ?>">Lista de Demandas</a>
                                    </li>
                                    <li>
                                        <a class="art-menu" href="<?php echo url_for('turmacoordenador/index') ?>">Lista de Turmas do Curso</a>
                                    </li>
                        </ul>
